  ...
  return (
      <section>
            <div className='container p-2 md:p-0 md:relative'>
                ...
                <div className='bookshadow md:w-[1320px] md:absolute bg-white rounded-[16px] md:z-40 md:h-[140px] md:mt-[-75px] md:left-[50%] md:translate-x-[-50%] md:space-x-[120px] md:flex-row flex flex-col p-7  items-center justify-center'>
